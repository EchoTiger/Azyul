...
namespace Honorbuddy.Quest_Behaviors.RangePullBoss
{
    [CustomBehaviorFileName(@"RangePullBoss")]
    public class RangePull : CustomForcedBehavior
    {
        /// <summary>
        ...
        /// </summary>
        /// 
        public RangePull(Dictionary<string, string> args)
            : base(args)
        {
            try
            {
        ...
        public Composite KillAdds
        {
            get
            {
                return new Decorator(r => Adds != null, new PrioritySelector(
        ...
        public Composite PullBoss
        {
            get
   {
       return new Decorator(r => !PulledYet,
         new Action(context =>
         {
             Boss.Target();
             ...
             switch (Me.Class)
             {
                 case WoWClass.DeathKnight: SpellManager.Cast("Death Grip"); break;
                 ...
                 case WoWClass.Shaman: SpellManager.Cast("Earth Shock"); break;
                 case WoWClass.Warlock: SpellManager.Cast("Bane of Agony"); break;
                 case WoWClass.Warrior: SpellManager.Cast("Throw"); break;
             }
        ...
        public Composite KillBoss
        {
            get
            {
                return new Decorator(r => Adds == null && Boss != null && ((Boss.Location.Z - StyxWoW.Me.Location.Z) < 3), new PrioritySelector(
        ...
        {
            return _root ?? (_root = new Decorator(ret => !_isBehaviorDone, new PrioritySelector(DoneYet, PullBoss, KillAdds, KillBoss)));
        }
